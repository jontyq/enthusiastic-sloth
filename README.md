...
1. Get "Content Delivery API - access token" from your Contentful [project space](https://app.contentful.com/spaces/3gkhnkre243z/api/keys/)
...
To start editing your site, you can use the Contentful interface at [https://app.contentful.com/spaces/3gkhnkre243z](https://app.contentful.com/spaces/3gkhnkre243z).
